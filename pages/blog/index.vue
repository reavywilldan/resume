      ...
      <ul class="blog-posts-list">
          ...
          <a href="https://bit.ly/ADLink-Docs">
            ...
            <figure class="blog-banner-box">
              <img
                ...
                alt="ADLink Documentation" loading="lazy">
            </figure>
          ...
          <a href="https://blog.agcrisbp.my.id/posts/cara-install-phpmyadmin-di-android-menggunakan-termux">
            ...
            <figure class="blog-banner-box">
              <img
                ...
                alt="Cara Install PHPMyAdmin Di Android Menggunakan Termux" loading="lazy">
            </figure>
        ...
        <li class="blog-post-item">
          <a href="https://blog.agcrisbp.my.id/posts/cara-mengirim-foto-ukuran-asli-di-whatsapp">
            ...
            <figure class="blog-banner-box">
              <img src="https://raw.githubusercontent.com/agcrisbp/blog/main/public/wa.png"
                alt="Cara Mengirim Foto Ukuran Asli Di WhatsApp" loading="lazy">
            </figure>
          ...
          <a href="https://blog.agcrisbp.my.id/posts/how-to-calculated-age-using-javascript">
            ...
            <figure class="blog-banner-box">
              <img
                ...
                alt="How To Calculated Age For Date of Birth Using JavaScript" loading="lazy">
            </figure>
          ...
          <a href="https://blog.agcrisbp.my.id/posts/php-redirect-using-get-parameter">
            ...
            <figure class="blog-banner-box">
              <img
                ...
                alt="PHP Redirect Using $GET Parameter In HTML" loading="lazy">
            </figure>
          ...
          <a href="https://blog.agcrisbp.my.id/posts/cara-mengeluarkan-akun-google">
            ...
            <figure class="blog-banner-box">
              <img
                ...
                alt="Cara Mengeluarkan Akun Google Di Perangkat Lain" loading="lazy">
            </figure>
